...
const (
	BUTTON_CALL_UP   dataTypes.ElevButtonTypeT = 0
	BUTTON_CALL_DOWN dataTypes.ElevButtonTypeT = 1
	BUTTON_COMMAND   dataTypes.ElevButtonTypeT = 2
)
...
var (
	...
	lampChannelMatrix = [dataTypes.N_FLOORS][dataTypes.N_BUTTONS]int{
	...
	buttonChannelMatrix = [dataTypes.N_FLOORS][dataTypes.N_BUTTONS]int{
...
func ElevGetButtonSignal(button dataTypes.ElevButtonTypeT, floor int) int {
...
func ElevSetButtonLamp(button dataTypes.ElevButtonTypeT, floor, value int) {
	if value == 1 {
